...
import { COMPANY, PRODUCTS, STATS, TESTIMONIALS } from "../data/demo"
      ...
      <Section className="mt-24">
        <div className="flex flex-col items-center gap-6 rounded-3xl border border-border bg-accent/40 px-6 py-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <ButtonLink to="/order" size="lg">Захиалга өгөх</ButtonLink>
            <ButtonLink to="/contact" size="lg" variant="outline">Зөвлөгөө авах</ButtonLink>
          </div>
        </div>
      </Section>
    </div>
