import type { NewsItem, Order, PricingType, Product } from "./types"
  ...
  return [
    {
      ...
      phoneNormalized: "99112233",
      emailLower: "batbold@example.mn",
    },
    {
      code: "LN-3MW7Z2",
      createdAt: daysAgo(5),
      ...
      phoneNormalized: "88445566",
      emailLower: "saraa@example.mn",
    },
    {
      code: "LN-5RT9LK",
      createdAt: daysAgo(0),
      ...
      phoneNormalized: "95012345",
      emailLower: "temka@example.mn",
    },
  ]
}
