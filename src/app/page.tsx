    ...
    <div>
      <Section className="relative pt-16 sm:pt-24">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <Reveal from="load" delay={0.12} className="relative">
            <Parallax className="relative aspect-[5/4] overflow-hidden rounded-3xl border border-border bg-muted shadow-2xl shadow-ink/10">
              <ImageWithSkeleton
      ...
      <Section className="mt-24">
        ...
        <Reveal stagger={0.06} className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {SERVICES.map((s) => (
            <div
              key={s.title}
              className="group rounded-2xl border border-border bg-card p-6 transition-colors duration-200 hover:border-primary/40 motion-reduce:transition-none"
            >
              <span className="grid h-12 w-12 place-items-center rounded-xl bg-accent text-accent-foreground transition-colors duration-200 group-hover:bg-primary group-hover:text-primary-foreground motion-reduce:transition-none">
      ...
      <Section className="mt-24">
        ...
        <Reveal stagger={0.07} className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {featured.map((p) => (
      ...
      <Section className="mt-24">
        <Reveal>
          <div className="rounded-3xl bg-ink px-6 py-14 text-white sm:px-12">
            ...
            <Reveal stagger={0.1} className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {STEPS.map((s) => (
                <div key={s.n}>
