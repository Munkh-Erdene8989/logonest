      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-16 sm:px-8 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm text-white/70">
            <li><Link href="/products" className="hover:text-primary">Бүтээгдэхүүн</Link></li>
            <li><Link href="/calculator" className="hover:text-primary">Үнэ тооцоолуур</Link></li>
            <li><Link href="/order" className="hover:text-primary">Захиалга өгөх</Link></li>
            <li><Link href="/track" className="hover:text-primary">Захиалга хянах</Link></li>
          </ul>
        </div>
